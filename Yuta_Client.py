...
def abrir_workbooks(pasta_faturamentos: Path):
    ...
    arquivo1 = arquivos_1[0]  # pega o primeiro (se tiver mais de um, pode melhorar depois)
    ...
    print(f"Abrindo com xlwings:")
    print(f"• NAVIO:  {arquivo1}")
    print(f"• CLIENTE: {arquivo2}")
