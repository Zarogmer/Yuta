...
class CentralSanport:
    ...
    def mostrar_menu(self, selecionado=0):
        ...
        print("╔" + "═" * 62 + "╗")
        print(f"║{' 🚢 CENTRAL DE FATURAMENTO - SANPORT 🚢 '.center(60)}║")
        print("╚" + "═" * 62 + "╝\n")
    ...
    def rodar(self):
        ...
        while True:
            ...
            if key in (b'\r', b'\n'):
                ...
                if selecionado == 0:
                    print("╔" + "═" * 62 + "╗")
                    print("║" + " INICIANDO FATURAMENTO COMPLETO... ".center(60) + "║")
                    print("╚" + "═" * 62 + "╝\n")
                    try:
                    ...
                    print("╔" + "═" * 62 + "╗")
                    print("║" + " INICIANDO FATURAMENTO DE ACORDO... ".center(60) + "║")
                    print("╚" + "═" * 62 + "╝\n")
                    try:
